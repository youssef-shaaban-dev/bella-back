      ...
      <div className="container mx-auto px-6">
        ...
        <div className="reveal text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-gray-600 font-body text-lg leading-relaxed">
            Powering precision packaging solutions for the future of production. Behind our machinery is an elite cohort of mechanical innovators, R&D scientists, and precision fabricators.
          </p>
        </div>
