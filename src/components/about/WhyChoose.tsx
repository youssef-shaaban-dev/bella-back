      ...
      <div className="container mx-auto px-6">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8 stats-grid justify-center">
          {items.map((card, index) => (
            <div key={index} className="stat-card bg-white p-10 border border-gray-100 shadow-sm hover:shadow-xl transition-all duration-500 group flex flex-col h-full">
              ...
              <p className="text-gray-500 leading-relaxed grow text-sm font-body">
                {card.desc}
              </p>
            </div>
          ))}
