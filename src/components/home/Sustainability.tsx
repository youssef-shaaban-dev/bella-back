...
export default function Sustainability() {
  return (
    <section className="py-16 md:py-24 relative overflow-hidden text-white text-center">
      {/* Background image */}
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <ScrollReveal className="grid grid-cols-1 md:grid-cols-3 gap-8" stagger={80}>
          {features.map((item, idx) => {
            const Icon = item.icon;
            return (
              <div key={idx} className="flex flex-col items-center p-8 bg-white/5 backdrop-blur-sm border border-white/10 rounded-sm">
